...
Note: The computed risk score is based on the retrieved risks from the knowledge base and limited observed vulnerabilities from the garak results JSON.
